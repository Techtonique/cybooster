...
start = time()
sensi = regressor.get_sensitivities(X_test)
...
print("X_test.shape:", X_test.shape)
start = time()
sensi = regressor.get_sensitivities(X_test, columns=cols)
print(f"Elapsed for sensitivities: {time() - start} s")
print("sensi:", sensi)
print("sensi.shape:", sensi.shape)
...
print("sensi:", sensi)
print("sensi.shape:", sensi.shape)
feature_importances = regressor.get_feature_importances(X_test, columns=cols)
print("feature_importances:", feature_importances)
print("summary: \n", regressor.get_summary(X_test, columns=cols))