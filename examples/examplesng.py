...
regressor = NGBRegressor(LinearRegression(), feature_engineering=True)
start = time()
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print(f"Elapsed: {time() - start} s")
...
regressor = NGBRegressor(Ridge(), feature_engineering=True)
start = time()
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print(f"Elapsed: {time() - start} s")
...
regressor = SkNGBRegressor(Ridge(), feature_engineering=True)
start = time()
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print(f"Elapsed: {time() - start} s")
...
regressor = SkNGBRegressor(ExtraTreeRegressor(), feature_engineering=True)
start = time()
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print(f"Elapsed: {time() - start} s")
